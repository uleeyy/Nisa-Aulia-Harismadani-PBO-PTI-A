public class Main {
    public static void main(String[] args) {
        ...
        HourlyEmployee	hourlyEmployee	=	new HourlyEmployee("Karina", "234", 16.75, 40, null);
        CommissionEmployee	commissionEmployee	=	new CommissionEmployee("Keanu", "145", 10000, .06, null);
        BasePlusCommissionEmployee basePlusCommissionEmployee = new BasePlusCommissionEmployee("Bondan", "234", 5000, .04, 300, null);
